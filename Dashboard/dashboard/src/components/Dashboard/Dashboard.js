...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (savedDashboard) {
      const { widgets, name } = JSON.parse(savedDashboard);
      setWidgets(widgets || []);
  ...
  const handleSaveDashboard = () => {
    ...
    const dashboardData = { widgets, name: dashboardName };
  ...
  const handlePublishDashboard = () => {
    console.log("Publishing dashboard:", widgets);
    alert("Dashboard published! (Placeholder)");
  };
            ...
            >
              <AppBar
                ...
                sx={{
                  ...
                  borderRadius: 0,
                  boxShadow: (theme) =>
                    theme.components.MuiAppBar.styleOverrides.root.boxShadow,
                  py: 0, // Reduced vertical padding
                  minHeight: 48, // Smaller height
                }}
              >
                <Toolbar
                  variant="dense" // Use dense variant for smaller toolbar
                  sx={{
                    justifyContent: "space-between",
                    alignItems: "center",
                    minHeight: 48, // Override default height
                ...
                >
                  <Box sx={{ display: "flex", gap: 0.5 }}>
                    {widgetIcons.map(({ type, icon, tooltip }) => (
                      <Tooltip key={type} title={tooltip}>
                        ...
                        >
                          <IconButton
                            size="small" // Smaller icon buttons
                            color="inherit"
                  ...
                  >
                    <Typography
                      variant="subtitle1" // Smaller typography variant
                      sx={{
                        flexGrow: 1,
                        textAlign: "center",
                        fontWeight: 600,
                  ...
                  {/* Right: Save/Update and Publish Buttons */}
